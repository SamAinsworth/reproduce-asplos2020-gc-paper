...
echo "" > secmap.ini
$BASE/gem5-guardian/build/ARM/gem5.opt $BASE/gem5-guardian/configs/example/se.py  -c "$1" -o "$2" -i "$3" --l2cache -n 1  --num-main-cores=1 --cpu-type=arm_detailed --cpu2-type=minor --caches --l2cache --maxinsts=1000000000 --fast-forward=1000000000 --mem-size=2048MB; mv m5out/stats.txt m5out/statscfino.txt

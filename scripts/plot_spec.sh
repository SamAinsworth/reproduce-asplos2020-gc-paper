...
base=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsshadowno.txt | awk '{print $2}')
for n in 1 3 5 7 11
do
slow=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsshadow$n.txt  | awk '{print $2}')
echo $n $(expr $slow / $base) >> $BASE/plots/shadow.data
echo "\n" >> $BASE/plots/shadow.data
done
base=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statscounterno.txt | awk '{print $2}')
for n in 1 2 4 6 8 12
do
slow=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statscounter$n.txt  | awk '{print $2}')
echo $n $(expr $slow / $base) >> $BASE/plots/counter.data
echo "\n" >> $BASE/plots/counter.data
done
base=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsrowhammerno.txt | awk '{print $2}')
for n in 1 2 4 6 8 12
do
slow=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsrowhammer$n.txt  | awk '{print $2}')
echo $n $(expr $slow / $base) >> $BASE/plots/rowhammer.data
echo "\n" >> $BASE/plots/rowhammer.data
done
base=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsstatscfino.txt | awk '{print $2}')
for n in 1 2 4 6 8 12
do
slow=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsstatscfifine$n.txt  | awk '{print $2}')
echo $n $(expr $slow / $base) >> $BASE/plots/integrityfine.data
echo "\n" >> $BASE/plots/integrityfine.data
slow=$(grep sim_se *$bench/run/run_base_ref_aarch64.0000/m5out/statsstatscfi$n.txt  | awk '{print $2}')
